...
describe('Render test', function() {
    ...
    it('Buildin function range', function(done) {
        FT.render("test/test_templates/buildin.ft", "ol_range", [], function(res) {
            assert(res.indexOf('4') == -1);
            assert(res.indexOf('5') != -1);
            assert(res.indexOf('6') != -1);
            assert(res.indexOf('7') != -1);
            assert(res.indexOf('8') != -1);
            assert(res.indexOf('9') != -1);
            assert(res.indexOf('10') == -1);
            done();
        });
    });
    it('Buildin function loop', function(done) {
        FT.render("test/test_templates/buildin.ft", "ol_loop", [], function(res) {
            assert(res.indexOf('0') != -1);
            assert(res.indexOf('1') != -1);
            assert(res.indexOf('2') != -1);
            assert(res.indexOf('3') != -1);
            assert(res.indexOf('4') != -1);
            assert(res.indexOf('5') != -1);
            assert(res.indexOf('6') != -1);
            assert(res.indexOf('7') != -1);
